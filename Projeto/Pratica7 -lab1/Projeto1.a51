...
sentido_horario:
	...
	mov R0,#171d
	mov var2, #3d
	jb var3, passo_completo_horario_lento_ljmp 
	acall passo_completo_horario
	djnz R5, sentido_horario
	jmp imprime_fim
passo_completo_horario_lento_ljmp:	
	ljmp passo_completo_horario_lento
...
sentido_anti_horario:
	...
	mov R0,#171d
	mov var2, #3d
	jb var3, passo_completo_anti_horario_lento_ljmp 
	acall passo_completo_anti_horario
	djnz R5, sentido_anti_horario
	jmp imprime_fim
passo_completo_anti_horario_lento_ljmp:
	ljmp passo_completo_anti_horario_lento
...
passo_completo_horario:
	...
	mov r0, #171d
	djnz var2, passo_completo_horario
    ret
passo_completo_horario_lento:
	jnb P1.4, imprime_fim
	acall delay_step_motor_lento
    clr P2.0
    clr P2.1
    clr P2.2
    clr P2.3
    ...
    clr P2.1
    setb P2.0
	djnz R0, passo_completo_horario_lento
	mov r0, #171d
	djnz var2, passo_completo_horario_lento
	clr var3
	djnz R5, sentido_horario_ljmp
    ljmp imprime_fim
sentido_horario_ljmp:
	ljmp sentido_horario
...
passo_completo_anti_horario:
	...
	mov r0, #171d
	djnz var2, passo_completo_anti_horario
	ret
	
passo_completo_anti_horario_lento:
	jnb P1.4, imprime_fim_ljmp1
	acall delay_step_motor_lento
    clr P2.0
    clr P2.1
    clr P2.2
    ...
    clr P2.2
    setb P2.3
    djnz R0, passo_completo_anti_horario_lento
	mov r0, #171d
	djnz var2, passo_completo_anti_horario_lento
    clr var3
	djnz R5, sentido_anti_horario_ljmp
    ljmp imprime_fim
sentido_anti_horario_ljmp:
	ljmp sentido_anti_horario
...
meio_passo_horario:
    ...
    acall delay_step_motor
    SETB P2.3
	djnz R0, meio_passo_horario
	mov r0, #171d
	djnz var2, meio_passo_horario
	ret

imprime_fim_ljmp1:
	ljmp imprime_fim

meio_passo_horario_lento:
	jnb P1.4, imprime_fim_ljmp1
    acall delay_step_motor_lento
    clr P2.0
    clr P2.1
    ...
    acall delay_step_motor_lento
    SETB P2.3
	djnz R0, meio_passo_horario_lento
	mov r0, #171d
	djnz var2, meio_passo_horario_lento
	clr var3
	djnz R5, sentido_horario_ljmp2
    ljmp imprime_fim
	ret
sentido_horario_ljmp2:
	ljmp sentido_horario
...
meio_passo_anti_horario:
    ...
    acall delay_step_motor
    SETB P2.0
	djnz R0, meio_passo_anti_horario
	mov r0, #171d
	djnz var2, meio_passo_anti_horario
	ret

meio_passo_anti_horario_lento:
	jnb P1.4, imprime_fim_ljmp1
    acall delay_step_motor_lento
    clr P2.0
    clr P2.1
    ...
    acall delay_step_motor_lento
    SETB P2.0
	djnz R0, meio_passo_anti_horario_lento
	mov r0, #171d
	djnz var2, meio_passo_anti_horario_lento
    clr var3
	djnz R5, sentido_anti_horario_ljmp2
    ljmp imprime_fim
sentido_anti_horario_ljmp2:
	ljmp sentido_anti_horario
;##########################################
